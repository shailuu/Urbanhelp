...
import { getNotifications, markNotificationAsRead, markAllNotificationsAsRead } from "../Services/api"; // Update path as needed
...
function Notifications({ userEmail }) {
  ...
  const fetchNotifications = useCallback(async () => {
    ...
    try {
      ...
      // Debugging: Log the fetched notifications to inspect structure
